				<div class="col-sm-12">
					<div class="features_items"><!--features_items-->
						...
						<?php  
                            ...
                            $query = "SELECT * FROM tbl_products ORDER BY product_id DESC LIMIT 12";
					...
					<div style="text-align: center;">
						<a href="shop.php" class="btn btn-default btn-lg get text-center" style="    -webkit-animation: bounce 2s ease infinite;
    animation: bounce 2s ease infinite;">View All Product</a>
					</div>
